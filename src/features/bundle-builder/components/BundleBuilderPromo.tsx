          ...
          <div className="mb-12 lg:mb-0">
            <div className="inline-flex items-center px-4 py-2 bg-blue-100 dark:bg-blue-900/50 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-blue-600 dark:text-blue-400">
                {bundles.length > 0 ? `${bundles.length} Bundles Created` : 'Featured Bundles'}
              </span>
            </div>
            ...
            <div className="space-x-4">
              ...
              {bundles.length > 0 && (
                <Link
                  to="/bundles"
                  className="inline-flex items-center px-6 py-3 bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600"
                >
                  View My Bundles
